...
# It seems like this should work, it's just testing an analytic calculation against
# the uvsim calcuation, but the visibilities appear to be off by ~ a factor of 2
@nt.nottest
def test_single_offzenith_source_miriad():
    """Test single off-zenith source using test uvdata file."""
    miriad_uv = UVData()
    miriad_uv.read_miriad(hera_miriad_file, ant_str='9_10')
    ...
    uvw_wavelength_array = miriad_uv.uvw_array * units.m / const.c * freq.to('1/s')
