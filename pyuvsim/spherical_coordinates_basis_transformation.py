...
def verify_orthogonal(rot_matrix, tol=1e-15):
    return np.allclose(np.matmul(rot_matrix, rot_matrix.T), np.eye(3), atol=tol)


def verify_unit(vec, tol=1e-15):
