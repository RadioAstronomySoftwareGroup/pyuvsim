...
def coherency_to_stokes(coherency_matrix):
    ...
    if (coherency_matrix.shape)[0] != 2 or (coherency_matrix.shape)[1] != 2:
        raise ValueError('First two dimensions of coherency_matrix must be length 2.')

    if coherency_arr.size == 4:
