...
# TODO: fully replace this file with the proper method of downloading pooch files
...
file_download_dict = {
    ...
    "gleam": {"function": download_gleam, "args": [], "kwargs": {"path": file_cache}},
}
...
def download_from_instructions(filename, instruction):
    """
    Take as input the filename and a dictionary containing three keys.

    Uses the dictionary to construct a download method to download the
    file, and calls the method.

    Parameters
    ----------
    filename:  str
        The filename only used for print statement logic.
    instruction: dict
